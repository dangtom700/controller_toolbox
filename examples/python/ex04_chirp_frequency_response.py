...
Verification    :
  - |H(jωn)| at ωn = 1 rad/s ≈ 1/ζ_peak (for ζ=0.75, peak ≈ 0 dB).
  - Phase at ω=0.1 rad/s ≈ −arctan(1.5×0.1 / (1−0.01)) ≈ −8.5°.
...
print(f"  {'ω (rad/s)':>12}  {'|H| analytic':>14}  {'|H| estimated':>14}  {'err':>8}")
...
print(f"\n  Phase at ω=0.1: estimated={phase_low:.1f}°, analytic={phase_analytic:.1f}°")
