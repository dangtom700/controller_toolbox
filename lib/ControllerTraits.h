...
// ── DiscretePID ───────────────────────────────────────────────
template<> struct ControllerTraits<DiscretePID> {
...
// ── DiscreteLQR ───────────────────────────────────────────────
template<> struct ControllerTraits<DiscreteLQR> {
...
// ── DiscreteLQG ───────────────────────────────────────────────
template<> struct ControllerTraits<DiscreteLQG> {
...
// ── DiscreteMPC ───────────────────────────────────────────────
template<> struct ControllerTraits<DiscreteMPC> {
...
template<> struct ControllerTraits<ExtremumSeeker> {
...
template<> struct ControllerTraits<DiscreteSMC> {
...
template<> struct ControllerTraits<DiscreteADRC> {
...
// ── DiscreteLeadLag ───────────────────────────────────────────
template<> struct ControllerTraits<DiscreteLeadLag> {
...
template<> struct ControllerTraits<SmithPredictor> {
