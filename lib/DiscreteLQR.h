...
public:
    ...
    // Throws std::runtime_error if DARE does not converge or (A,B) is not stabilisable.
...
private:
    ...
    // Value-iteration DARE solver (Bertsekas, "Dynamic Programming and Optimal Control").
    static Eigen::MatrixXd solveDARE(const Eigen::MatrixXd& A,
